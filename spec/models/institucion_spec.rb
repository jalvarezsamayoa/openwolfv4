...
describe Institucion, :solr => true do
  ...
  def setup_defaults
    @institucion = FactoryGirl(:institucion)
    @usuario = FactoryGirl(:usuario, :institucion => @institucion)

    @departamento = FactoryGirl(:departamento)
    @municipio = FactoryGirl(:municipio, :departamento => @departamento)
    @via = FactoryGirl(:via)
    @profesion = FactoryGirl(:profesion)
    @genero = FactoryGirl(:genero)
    @rangoedad = FactoryGirl(:rangoedad)
    @clasificacion = FactoryGirl(:clasificacion)
    @documentoclasificacion = FactoryGirl(:documentoclasificacion)
  ...
  def solicitud_activa(opts = nil)
    ...
    FactoryGirl(:solicitud, opciones)
  end
